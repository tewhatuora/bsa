...
Alias: $ValueSet-pathway-state =   https://nzhts.digital.health.nz/fhir/ValueSet/bas-pathway-state
Alias: $ValueSet-pathway-substate =  https://nzhts.digital.health.nz/fhir/ValueSet/bsa-pathway-substate

Alias: $Profile-BsaCarePlan =  http://hl7.org.nz/fhir/StructureDefinition/BsaCarePlan
Alias: $Profile-BsaDiagnosticReport =  http://hl7.org.nz/fhir//StructureDefinition/BsaDiagnosticReport
