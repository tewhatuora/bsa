...
let outFile1 = "./input/pagecontent/API.md";  // for IG publisher
            ...
            capStmt.rest.forEach(function(rest){
                rest.resource.forEach(function(res){
                    ...
                    if (res.documentation) {
                        ...
                        ar.push(`${documentation}  `)
                        
                        console.log("res doc : " + res.documentation)
                    }

                    if (res.interaction) {
                       ar.push("**Interactions**  ")
                       ar.push("\r")
                       ar.push("<table><style>table, th, td { border: 1px solid black;border-collapse: collapse;}</style>");
                        ...
                        res.interaction.forEach(function(int){
							console.log("interaction doc: " +  int.documentation)
                            ar.push("<tr>")
